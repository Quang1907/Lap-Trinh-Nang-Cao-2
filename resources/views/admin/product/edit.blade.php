            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <form class="forms-sample" action="{{ route('products.update', $product) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-3 d-flex">
                                        ...
                                        @php
                                            $private = $public = '';
                                        @endphp
                                        @php($product->status == 1 ? ($public = 'checked') : ($private = 'checked'))
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            ...
                                            <div class="input-group-append">
                                                <input type="text" class="form-control d-none" id='image' name='image'
                                                    placeholder="Tải lên hình ảnh" value='{{ $product->image }}'>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="desc" class="form-control my-editor">{{ $product->desc }}</textarea>
                                        @error('desc')
