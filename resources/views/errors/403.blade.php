...
@section('css')
    <style>
        ...
        :root {
            ...
            --animation-sentence: 'Bạn biết bạn phải rời đi, phải không?';
        ...
        * {
        ...
        @keyframes showText {
            ...
            100% {
                --animation-sentence: 'Quá nhiều việc để làm nhưng thời gian lại ít...';
            }
        }
        ...
        @keyframes showNewText {
            ...
            100% {
                --animation-sentence: 'Được rồi, bạn có vẻ quan tâm đến điều này. Đây là chìa khóa dành riêng cho bạn';
            }
        }
    ...
    <div class="content-wrapper bg-secondary">
        <div>
            ...
            <div class=" container mt-0">
                <h1>403</h1>
                <p>Quyền truy cập không được cấp</p>
